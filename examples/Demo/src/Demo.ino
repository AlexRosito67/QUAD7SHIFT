/* Include the QUAD7SHIFT library
    to drive 4 digits seven segment displays
    for modules that use 74HC595 shiftregisters.
...
QUAD7SHIFT myDisplay(COMMON_CATHODE); // Change this to your display configuration (COMMON_ANODE or COMMON_CATHODE)
